INSERT INTO photo (id, title, extract, description, location, date, url) VALUES (1, 'Photo 1', 'Photo 1 extract', 'Photo 1 description', ST_GeomFromText('POINT(52.5162198 13.3776884)', 4326) , '2010-10-20', 'http://localhost/images/img1.jpg');
INSERT INTO photo (id, title, extract, description, location, date, url) VALUES (2, 'Photo 2', 'Photo 2 extract', 'Photo 2 description', ST_GeomFromText('POINT(52.5208415 13.4094134)', 4326) , '2010-10-20', 'http://localhost/images/img2.jpg');
INSERT INTO photo (id, title, extract, description, location, date, url) VALUES (3, 'Photo 3', 'Photo 3 extract', 'Photo 3 description', ST_GeomFromText('POINT(52.5144484 13.3501743)', 4326) , '2010-10-20', 'http://localhost/images/img3.jpg');
